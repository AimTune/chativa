...
![Survey screen mode](./assets/screenshots/sandbox/survey-screen.png)
> _Screenshot placeholder._

## Configuration

Set under `theme.endOfConversationSurvey`. Default: enabled. Full schema: [`schemas/theme.schema.json`](../schemas/theme.schema.json) → `endOfConversationSurvey`.
