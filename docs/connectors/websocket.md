...
Schema: [`schemas/connectors/websocket.schema.json`](../../schemas/connectors/websocket.schema.json).
...
Each text frame must be a JSON-encoded `IncomingMessage`. See [`schemas/messages/incoming-message.schema.json`](../../schemas/messages/incoming-message.schema.json).
