...
![Loading the unpacked extension](./assets/screenshots/extension/load-unpacked.png)
...
![Popup → injected widget side by side](./assets/screenshots/extension/inject.png)
> _Screenshot placeholder._
...
[`apps/chrome-extension/manifest.json`](../apps/chrome-extension/manifest.json):
...
> The icon files live under `apps/chrome-extension/public/icons/`. See [docs/assets/screenshots/README.md](./assets/screenshots/README.md) for the full list of artwork the extension needs (16 / 32 / 48 / 128 px).
