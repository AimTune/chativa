...
sidebar_position: 3
title: Custom
description: Register a LitElement to render any custom message type — including overriding the built-ins.
---
...
The `/new-message-type` slash command creates the LitElement file, sibling test, and updates the `packages/ui/src/index.ts` side-effect imports. See [`.claude/commands/new-message-type.md`](https://github.com/AimTune/chativa/blob/main/.claude/commands/new-message-type.md).
