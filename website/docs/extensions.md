...
sidebar_position: 1
title: Extensions
description: Middleware lifecycle — onBeforeSend, onAfterReceive, onWidgetOpen/Close. Register slash commands. Use EventBus for read-only hooks.
---
...
Full event payload map: [`packages/core/src/application/EventBus.ts`](https://github.com/AimTune/chativa/blob/main/packages/core/src/application/EventBus.ts).

## Tip — use the scaffolder

The `/new-extension` slash command scaffolds the extension class, test, and a sandbox-ready install snippet. See [`.claude/commands/new-extension.md`](https://github.com/AimTune/chativa/blob/main/.claude/commands/new-extension.md).
