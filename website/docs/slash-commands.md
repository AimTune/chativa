...
description: Register custom slash commands — /help, /clear, /your-command. Lazy descriptions for i18n.
---
...
| `/genui`, `/genui-weather`, `/genui-form` _(DummyConnector only)_ | Trigger the demo GenUI streams. See [GenUI overview](./genui/overview.md). |
