...
sidebar_position: 5
title: DirectLine
description: Azure Bot Framework DirectLine v3 adapter — typing indicators, file uploads, history, message status, feedback, conversation resume.
---
...
Schema: [`schemas/connectors/directline.schema.json`](https://github.com/AimTune/chativa/blob/main/schemas/connectors/directline.schema.json).
