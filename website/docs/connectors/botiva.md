...
sidebar_position: 6
title: Botiva
description: Client adapter for botiva servers (Botiva Wire Protocol v1) — identity handshake, watermark resume, authentication, tool calls, GenUI and human-in-the-loop.
---
...
Schema: [`schemas/connectors/botiva.schema.json`](https://github.com/AimTune/chativa/blob/main/schemas/connectors/botiva.schema.json).
