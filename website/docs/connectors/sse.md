...
sidebar_position: 6
title: SSE
description: Server-Sent Events adapter — EventSource for receive, REST POST for send.
---
...
Schema: [`schemas/connectors/sse.schema.json`](https://github.com/AimTune/chativa/blob/main/schemas/connectors/sse.schema.json).
...
See [`schemas/messages/history-result.schema.json`](https://github.com/AimTune/chativa/blob/main/schemas/messages/history-result.schema.json).
