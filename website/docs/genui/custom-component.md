...
The `/new-genui-component` slash command creates the LitElement file, sibling test, and updates the central `packages/genui/src/index.ts` registration block. See [`.claude/commands/new-genui-component.md`](https://github.com/AimTune/chativa/blob/main/.claude/commands/new-genui-component.md).

## See also

- [Streaming protocol](./streaming.md) — chunks, event routing, `receiveComponentEvent`.
- Built-in source examples — [`packages/genui/src/components/`](https://github.com/AimTune/chativa/tree/main/packages/genui/src/components) — copy/paste any of them as a starting template.
