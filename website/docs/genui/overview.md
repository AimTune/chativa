...
sidebar_position: 1
title: Overview
description: Generative UI — stream LitElement components inline inside a chat message.
---
...
| Topic | Page |
|---|---|
| The streaming protocol (`AIChunk`) | [Streaming](./streaming.md) |
| Built-in components | [Built-in](./built-in.md) |
| Register your own component | [Custom component](./custom-component.md) |
