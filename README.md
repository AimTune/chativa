...
| Capability | Details |
|---|---|
| **Pluggable connectors** | [Dummy, WebSocket, SignalR, DirectLine, Botiva, SSE, HTTP](docs/connectors/overview.md) — or write your own. |
...
packages/
  ...
  connector-botiva/      @chativa/connector-botiva
